...
2. Select rows and columns using positional (iloc) and label-based (loc / column indexing) methods.
3. Filter records dynamically using Boolean logic on DataFrame columns.
4. Extract well-defined data subsets while keeping the original DataFrame immutable.
